...
def create_content_for_pets(pets):
    ...
    # Humorous adventure stories for each pet
    story_templates = {
        "Pepper": "Meet Pepper, the mysterious black cat detective who has appointed herself as the neighborhood's Chief Security Officer. Her daily routine includes conducting thorough investigations of suspicious paper bags, interrogating dust bunnies, and filing detailed reports (by knocking things off tables). Pepper's greatest case was 'The Mystery of the Disappearing Treats,' which she solved by catching the dog red-pawed. She's seeking a family who appreciates her investigative skills and doesn't mind her habit of leaving 'evidence' (toy mice) in shoes as case files.",
        
        "Winnie": "Winnie, the distinguished Russian Blue, has established herself as Alexandria's most refined feline socialite. At her age, she's mastered the art of dignified living and hosts daily 'Whisker & Wisdom' sessions where she shares life advice with younger cats. Her philosophy: 'Naps are not optional, they're essential.' Winnie is looking for a retirement home where she can continue her legacy as the neighborhood's most elegant philosopher, preferably with a sunny windowsill and premium catnip service.",
        
        "Zebra": "Zebra, the tuxedo cat with a name that confuses everyone, has decided to embrace his identity crisis by becoming the shelter's official Welcome Committee of One. He greets every visitor with enthusiastic head bumps and purr-negotiations, convinced he's actually a dog trapped in a cat's body. His daily schedule includes: morning tail-wagging practice, afternoon visitor greeting, and evening 'How to Be More Dog' workshops for confused cats. He's seeking a family who won't mind his existential crisis and will love his over-the-top personality.",
        
        "Rebekah": "Rebekah, the German Shepherd mix, has appointed herself as Alexandria's Chief Happiness Officer and Professional Tail-Wagger. She takes her job seriously, conducting daily joy inspections throughout the neighborhood and organizing impromptu play sessions for anyone who looks remotely sad. Her resume includes: Expert Treat Tester, Certified Good Girl, and Advanced Belly Rub Recipient. She's looking for a family who needs a professional happiness consultant and doesn't mind her over-enthusiasm for making everyone's day better.",
        
        "Crouton": "Crouton, the golden food critic, earned his name after a legendary incident involving a salad bar and his insatiable curiosity about human food. He's since become the shelter's official taste-tester and dining experience coordinator. His latest review: 'The morning kibble shows remarkable consistency with hints of chicken and a robust crunch - 4.5 paws out of 5.' He's established a waiting list for his exclusive 'Dinner and a Movie' nights. Crouton is seeking a family who appreciates fine dining and needs a professional food quality inspector."
    }
    ...
    for pet in pets:
        ...
        # Add humorous story
        story = story_templates.get(name, f"{name} is an amazing {pet['type'].lower()} looking for a loving home!")
